            ...
            else
            {
                ...
                if (poseEditorExpanded.boolValue)
                {
                    ...
                    else
                    {
                        ...
                        if (handTexL == null)
                            handTexL = (Texture)EditorGUIUtility.Load("Assets/Resources/Icons/HandLeftIcon.png");
                        if (handTexR == null)
                            handTexR = (Texture)EditorGUIUtility.Load("Assets/Resources/Icons/HandRightIcon.png");
