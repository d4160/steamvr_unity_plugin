...
namespace Valve.VR
{
    public class SteamVR_Behaviour_Skeleton : MonoBehaviour
    {
        ...
        public XRInputAction_SkeletonSource skeletonAction;
        ...
        /// <summary>The fallback SkeletonPoser to drive hand animation when no skeleton data is available</summary>
        public XRInputAction_Single fallbackCurlAction;
        ...
        void Start()
        {
            fallbackCurlAction.InputDevice = inputSource == SteamVR_Input_Sources.LeftHand ?
                                            XRInputDevices.GetLeftHand() : XRInputDevices.GetRightHand();
        }
        ...
        public bool isActive { get { return true; } } //skeletonAction.GetActive()
        ...
        public float[] fingerCurls
        {
            get
            {
                ...
                else
                {
                    ...
                    for (int i = 0; i < 5; i++)
                    {
                        curls[i] = fallbackCurlAction.GetAxis();
                    }
                    return curls;
                }
            }
        ...
        public float thumbCurl
        {
            get
            {
                if (skeletonAvailable)
                    ...
                    return fallbackCurlAction.GetAxis();
            }
        }
