...
namespace Valve.VR
{
    public class SteamVR_Settings : ScriptableObject
    {
        ...
        {
            //Debug.Log($"1 LoadInstance _instance null? {_instance == null}");
            if (_instance == null)
            {
                _instance = Resources.Load<SteamVR_Settings>("SteamVR_Settings");

                //Debug.Log($"2 LoadInstance _instance null? {_instance == null}");
                if (_instance == null)
                {
                    ...
                    localFolderPath = System.IO.Path.Combine("Assets", "Resources");
                    ...
                    //Debug.Log($"AssetPath2: {assetPath}");
