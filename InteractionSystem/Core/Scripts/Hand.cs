...
namespace Valve.VR.InteractionSystem
{
    ...
    public class Hand : MonoBehaviour
    {
        ...
        public XRInputAction_Boolean grabPinchAction;
        //public SteamVR_Action_Boolean grabPinchAction = SteamVR_Input.GetAction<SteamVR_Action_Boolean>("GrabPinch");

        public XRInputAction_Boolean grabGripAction;
        //public SteamVR_Action_Boolean grabGripAction = SteamVR_Input.GetAction<SteamVR_Action_Boolean>("GrabGrip");

        public XRInputAction_Haptics hapticAction;
        //public SteamVR_Action_Vibration hapticAction = SteamVR_Input.GetAction<SteamVR_Action_Vibration>("Haptic");

        public XRInputAction_Boolean uiInteractAction;
        ...
        protected void InitializeInputActions()
        {
            if (handType == SteamVR_Input_Sources.LeftHand)
                _inputDevice = XRInputDevices.GetLeftHand();
            else if (handType == SteamVR_Input_Sources.RightHand)
                _inputDevice = XRInputDevices.GetRightHand();

            grabPinchAction.InputDevice = _inputDevice;
            grabGripAction.InputDevice = _inputDevice;
            hapticAction.InputDevice = _inputDevice;
            uiInteractAction.InputDevice = _inputDevice;
        }
        ...
        public void TriggerHapticPulse(ushort microSecondsDuration)
        {
            ...
            hapticAction.duration = seconds;
            hapticAction.amplitude = 1;
            hapticAction.Execute();
        }

        public void TriggerHapticPulse(float duration, float frequency, float amplitude)
        {
            hapticAction.duration = duration;
            hapticAction.amplitude = amplitude;
            hapticAction.Execute();
        }
        ...
        public GrabTypes GetGrabStarting(GrabTypes explicitType = GrabTypes.None)
        {
            if (explicitType != GrabTypes.None)
            {
                ...
                if (explicitType == GrabTypes.Pinch && grabPinchAction.GetStateDown())
                    return GrabTypes.Pinch;
                if (explicitType == GrabTypes.Grip && grabGripAction.GetStateDown())
            ...
            else
            {
                ...
                if (grabPinchAction.GetStateDown())
                    return GrabTypes.Pinch;
                if (grabGripAction.GetStateDown())
                    return GrabTypes.Grip;
            }
        ...
        public GrabTypes GetGrabEnding(GrabTypes explicitType = GrabTypes.None)
        {
            if (explicitType != GrabTypes.None)
            {
                ...
                if (explicitType == GrabTypes.Pinch && grabPinchAction.GetStateUp())
                    return GrabTypes.Pinch;
                if (explicitType == GrabTypes.Grip && grabGripAction.GetStateUp())
                    return GrabTypes.Grip;
            }
            else
            {
                ...
                if (grabPinchAction.GetStateUp())
                    return GrabTypes.Pinch;
                if (grabGripAction.GetStateUp())
                    return GrabTypes.Grip;
            }
        ...
        public bool IsGrabbingWithType(GrabTypes type)
        {
            ...
            switch (type)
            {
                case GrabTypes.Pinch:
                    return grabPinchAction.GetState();

                case GrabTypes.Grip:
                    return grabGripAction.GetState();
