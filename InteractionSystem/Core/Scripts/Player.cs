...
namespace Valve.VR.InteractionSystem
{
	...
	public class Player : MonoBehaviour
	{
		...
		public bool startWithVRMode = true;
        ...
        protected virtual void Update()
        {
            ...
            //    return;
						var userPresentStateLastFrame = XRInputHelper.BecomeUserPresentState();
						var userNotPresentStateLastFrame = XRInputHelper.BecomeUserNotPresentState();

						if (userPresentStateLastFrame)
						{
								Debug.Log("<b>SteamVR Interaction System</b> Headset placed on head");
						}
						else if (userNotPresentStateLastFrame)
						{
		...
		void OnDrawGizmos()
		{
			...
			for ( int i = 0; i < count; i++ )
			{
				...
				{
					Gizmos.DrawIcon( hand.transform.position, "vr_interaction_system_left_hand.png", true );
				}
				else if ( hand.handType == SteamVR_Input_Sources.RightHand)
				{
					Gizmos.DrawIcon( hand.transform.position, "vr_interaction_system_right_hand.png", true );
				}
				else
				{
                    /*
