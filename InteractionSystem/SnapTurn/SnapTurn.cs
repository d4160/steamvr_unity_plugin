...
namespace Valve.VR.InteractionSystem
{
    ...
    public class SnapTurn : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            snapLeftAction.InputDevice = XRInputDevices.GetLeftHand();
            snapRightAction.InputDevice = XRInputDevices.GetRightHand();
        }
        ...
        private void Update()
        {
            ...
            if (canRotate)
            {
                ...
                bool leftHandTurnLeft = snapLeftAction.GetStateDown() && leftHandValid;
                bool rightHandTurnLeft = snapLeftAction.GetStateDown() && rightHandValid;

                bool leftHandTurnRight = snapRightAction.GetStateDown() && leftHandValid;
                bool rightHandTurnRight = snapRightAction.GetStateDown() && rightHandValid;
